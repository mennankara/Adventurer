        ...
        public static T LoadAndTransformXamlFile<T>(string filename)
        {
            try
            {
                ...
                filecontent = filecontent.Replace(
                    "xmlns:converters=\"clr-namespace:Adventurer.UI.UIComponents.Converters\"",
                    "xmlns:converters=\"clr-namespace:Adventurer.UI.UIComponents.Converters;assembly=" +
                    Assembly.GetExecutingAssembly().GetName().Name + "\"");
                filecontent = filecontent.Replace(
                    "xmlns:uiComponents=\"clr-namespace:Adventurer.UI.UIComponents\"",
                    "xmlns:uiComponents=\"clr-namespace:Adventurer.UI.UIComponents;assembly=" +
                    Assembly.GetExecutingAssembly().GetName().Name + "\"");
                filecontent =
                    filecontent.Replace(
                        "xmlns:radarCanvas=\"clr-namespace:Adventurer.UI.UIComponents.RadarCanvas\"",
                        "xmlns:radarCanvas=\"clr-namespace:Adventurer.UI.UIComponents.RadarCanvas;assembly=" +
                        Assembly.GetExecutingAssembly().GetName().Name + "\"");
                filecontent = filecontent.Replace("xmlns:objects=\"clr-namespace:Adventurer.Objects\"",
                    "xmlns:objects=\"clr-namespace:Adventurer.Objects;assembly=" +
                    Assembly.GetExecutingAssembly().GetName().Name + "\"");
                filecontent = filecontent.Replace("xmlns:mock=\"clr-namespace:Adventurer.Settings.Mock\"",
                    "xmlns:mock=\"clr-namespace:Adventurer.Settings.Mock;assembly=" +
                    Assembly.GetExecutingAssembly().GetName().Name + "\"");
