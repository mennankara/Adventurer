...
namespace Adventurer.Coroutines
{
    ...
    public sealed class NavigationCoroutine
    {
        ...
        public static async Task<bool> MoveTo(Vector3 destination, int distance, [CallerMemberNameAttribute] string caller = "", [CallerFilePath] string callerPath = "")
        {
        ...
        private async Task<bool> NotStarted()
        {
            ...
            if (PluginEvents.CurrentProfileType == ProfileType.Rift &&
                distanceToDestination < 80f && zDiff < 3 &&
